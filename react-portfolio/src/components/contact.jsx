...
const Contact = ({ id }) => {
  return (
    <>
      ...
      <div className='container md:target my-20 md:my-24 max-w-full px-20 md:px-40 flex flex-col md:flex-row justify-center items-center gap-14 md:gap-20 text-[#FEFBF4]'>
